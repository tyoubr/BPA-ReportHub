...
describe("Appointment Form", (() => {
    ...
    describe("Recurrence Form", (() => {
        ...
        it("should be visible after changing repeat editor's value", (async () => {
            ...
            expect(null === (_POM$popup$mainGroup = POM.popup.mainGroup) || void 0 === _POM$popup$mainGroup ? void 0 : _POM$popup$mainGroup.getAttribute("inert")).toBeNull();
            expect(POM.popup.isRecurrenceGroupVisible()).toBe(false);
            expect(null === (_POM$popup$recurrence = POM.popup.recurrenceGroup) || void 0 === _POM$popup$recurrence ? void 0 : _POM$popup$recurrence.getAttribute("inert")).toBe("true");
            ...
            expect(null === (_POM$popup$mainGroup2 = POM.popup.mainGroup) || void 0 === _POM$popup$mainGroup2 ? void 0 : _POM$popup$mainGroup2.getAttribute("inert")).toBe("true");
            expect(POM.popup.isRecurrenceGroupVisible()).toBe(true);
            expect(null === (_POM$popup$recurrence2 = POM.popup.recurrenceGroup) || void 0 === _POM$popup$recurrence2 ? void 0 : _POM$popup$recurrence2.getAttribute("inert")).toBeNull();
            POM.popup.getBackButton().click();
            expect(POM.popup.component.option("height")).toBe("auto");
            expect(POM.popup.isMainGroupVisible()).toBe(true);
            expect(null === (_POM$popup$mainGroup3 = POM.popup.mainGroup) || void 0 === _POM$popup$mainGroup3 ? void 0 : _POM$popup$mainGroup3.getAttribute("inert")).toBeNull();
            expect(POM.popup.isRecurrenceGroupVisible()).toBe(false);
            expect(null === (_POM$popup$recurrence3 = POM.popup.recurrenceGroup) || void 0 === _POM$popup$recurrence3 ? void 0 : _POM$popup$recurrence3.getAttribute("inert")).toBe("true")
        }));
